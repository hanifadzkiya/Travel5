...
transactionRouter
  .route("/hotel/:username") //user dan admin
  ...
  .post(async (req, res, next) => {
    try {
      ...
      const transaksi = await transactionService.insertTransaction(
        req.params.username,
        "transactionHotel",
        req.body
      );
...
transactionRouter
  .route("/destination/:username") //user dan admin
...
transactionRouter
  .route("/tour/:username") //user dan admin
...
transactionRouter
  .route("/destination/:username/:idDestination") //user dan admin
  ...
  .get(async (req, res, next) => {
    try {
      ...
      const hasil = await result.transactionTempatWisata.id(
